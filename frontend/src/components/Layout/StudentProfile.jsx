        ...
        >
          ...
          <div className="pt-20 pb-6 px-6 md:px-8">
            <h1 className="text-3xl font-bold text-gray-800">
              {userData.candidateFullName || userData.name || "Student Profile"}
            </h1>
        ...
        >
          <div className="flex flex-wrap">
            <button
              ...
              className={`px-4 py-3 text-sm md:text-base font-medium border-b-2 transition-colors duration-200 flex items-center ${
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <InfoCard
                  ...
                  value={userData.physicallyDisabled === "Yes" ? "Yes" : "No"}
                />
                ...
                {userData.foreignLanguage && (
                  <InfoCard
                    ...
                    value={userData.foreignLanguageProficiency}
                  />
                )}
              </div>
            </motion.div>
            ...
            <motion.div className="space-y-6" variants={containerVariants}>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                  ...
                  <InfoCard
                    label="Percentage"
                    value={userData.percentage10th && `${userData.percentage10th}%`}
                  />
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                  ...
                  <InfoCard
                    label="Percentage"
                    value={userData.percentage12th && `${userData.percentage12th}%`}
                  />
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                  ...
                  <InfoCard
                    ...
                    value={
                      userData.aggregatePercentageDiploma && `${userData.aggregatePercentageDiploma}%`
                    }
                  />
          ...
          {activeSection === "degree" && (
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <InfoCard
                  label="Aggregate Percentage Till Sem 5"
                  value={userData.aggregatePercentageTillSem5 && `${userData.aggregatePercentageTillSem5}%`}
                />
                      ...
                      <div key={`degree-sem-${sem}`} className="bg-gray-50 p-4 rounded-lg">
                        ...
                        {userData[`sem${sem}PassingDate`] && (
                          <p className="text-gray-700">
                            <span className="font-medium">Passing Date:</span>{" "}
                            {formatDate(userData[`sem${sem}PassingDate`])}
                          </p>
                        )}
                      </div>
                    )
